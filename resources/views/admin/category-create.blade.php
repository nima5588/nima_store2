...
<div class="font-samim main-container container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-title">اضافه کردن دسته بندی</h1>
        <div>
            <ol class="breadcrumb">
            ...
            <div class="card">
                <form action="{{ route('category-insert') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <div class="card-title">دسته بندی جدید اضافه کنید</div>
                    </div>
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                @enderror
                                <input name="name" type="text" class="form-control" placeholder="اسم دسته بندی را وارد کنید">
                            </div>
                        </div>
                        <!-- Row -->
                        <div class="row">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <button type="submit" class="btn btn-primary">دسته بندی را اضافه کنید</button>
                                <a href="{{ route('category-list') }}" class="btn btn-default float-end">دور انداختن</a>
                            </div>
                        </div>
                        <!--End Row-->
                    </div>
