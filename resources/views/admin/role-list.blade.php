...
<div class="font-samim main-container container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-title">لیست ادمین ها</h1>
    </div>
    <!-- PAGE-HEADER END -->
            ...
            <div class="card cart">
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 text-end"><a href="{{ route('role-create') }}" class="btn btn-success float-sm-end">دسترسی به کاربر<i class="fa fa-arrow-left ms-1"></i></a></div>
                    </div>
                </div>
                <div class="card-body">
