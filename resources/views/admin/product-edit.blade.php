...
<div class="font-samim main-container container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-title">ویرایش کردن محصول</h1>
        <div>
            <ol class="breadcrumb">
            ...
            <div class="card">
                <form action="{{ route('product-update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <div class="card-title">محصول را ویرایش کنید</div>
                    </div>
                    <div class="card-body">
                        <div class="row mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 mb-4">
                                <textarea name="description" class="content" name="example">{!! $product->description !!}</textarea>
                            </div>
                        </div>
                        <!--End Row-->
                        ...
                        <div class="col-xl-5 px-4 px-xl-2">
                            <div class="form-group">
                                <label for="slide" class="custom-switch form-switch mb-0">
                                    <input type="checkbox" id="slide" name="is_slide" value="1" class="custom-switch-input" {{ $product->is_slide == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="ff_fileupload_wrap">
                                    ...
                                    <img src="{{ asset('img/'.$product->image) }}" width="100" alt="">
                                </div>
                            </div>
                        </div>
                        <!--End Row-->
                    ...
                    <div class="card-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <a href="{{ route('product-list') }}" class="btn btn-default float-end">بازگشت</a>
                            </div>
                        </div>
                        <!--End Row-->
                    </div>
